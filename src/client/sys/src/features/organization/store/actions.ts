...
export const setSorting = (state: OrganizationStore, sorting: any) => {
...
export const softResetTableState = (state: OrganizationStore) => {
  state.tableState.currentPage = 0;
...
export const loadTableState = (state: OrganizationStore, currentPath: string) => {
  try {
...
export const loadTableStateForPath = (state: OrganizationStore, currentPath: string) => {
  if (shouldClearTableState(state, currentPath)) {
    ...
    loadTableState(state, currentPath);
  }
};
